		    ...
		    onContentReady: function(){
		    	...
		    	$("#addGroupForm").ajaxForm({
		    		success: function(data, statusText, xhr, $form){
		    			var group = '<li class="groupMenu"><a href="/team/main.do?gid=' + data.newTeam.gid + '&gname=' + data.newTeam.gname + '">' + data.newTeam.gname + '</a></li>';
 	...
 	<div class="navbar navbar-inverse" role="banner">
		<div class="container">
			<div class="navbar-brand">
				<a class="logo-text" href="#" onclick="disconnectLocation('<%= request.getContextPath() %>/');">뿌리깊은마크</a>
